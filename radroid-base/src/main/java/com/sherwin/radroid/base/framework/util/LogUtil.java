...
import com.sherwin.radroid.base.framework.app.GlobalConfig;
...
public class LogUtil {
	...
	public static int LEVEL = GlobalConfig.getLogLevel();
	...
	public static void toast(String msg) {
		if (DEBUG >= LEVEL) {
			Toast.makeText(GlobalInfo.getContext(), msg, Toast.LENGTH_LONG).show();
		}
	}
