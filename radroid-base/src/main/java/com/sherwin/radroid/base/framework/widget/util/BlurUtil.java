package com.sherwin.radroid.base.framework.widget.util;
 ...
 * 毛玻璃效果处理
 * @author Sherwin.Ye
 * @data 2016年3月21日 下午5:11:04
 * @desc BlurUtil.java
 */
public class BlurUtil {

	public static Bitmap apply(Context context, Drawable drawable) {
		return apply(context, drawable, 10);
	}
	/**
	 * 
	 * @param context
	 * @param drawable
	 * @param radius Supported range 0 < radius <= 25
	 * @return
	 */
	public static Bitmap apply(Context context, Drawable drawable, int radius) {
		BitmapDrawable bd = (BitmapDrawable) drawable;
		return apply(context, bd.getBitmap());
	}
